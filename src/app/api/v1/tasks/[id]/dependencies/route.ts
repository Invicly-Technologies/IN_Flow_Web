...
import { addDependencySchema } from "@/features/tasks/validations/task.validations";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const task = await taskService.addDependency(id, workspaceId, body.blockerTaskId);
